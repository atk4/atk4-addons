...
class MVCForm_Export extends MVCForm {
    ...
    function addExportButtons(){
        ...
        $this->addButton("Export (XLS)", "export_xls")->js("click")->univ()->redirect($this->api->getDestinationURL(null, array("export_xls" => $this->name)));
        $this->addButton("Export (PDF)", "export_pdf")->js("click")->univ()->redirect($this->api->getDestinationURL(null, array("export_pdf" => $this->name)));
    }
