<?php
  ...
  *  4. Pass to checker name of new pass field       $rpc->setNewPassFieldName($f->getElement('new')->name);
 ...
 class RepeatPassChecker extends HtmlElement {
     ...
     function setNewPassFieldName($name) {
         $this->new_pass_field_name = $name; //var_dump($this->new_pass_field_name);
         return $this;
     }
